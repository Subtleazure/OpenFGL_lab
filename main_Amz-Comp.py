...
# 定义污染目录
contaminated_client_dir = "/data2/liujiaqi/openfgl_dataset/contaminated/Amz-Comp/distrib/subgraph_fl_louvain_1_Computers_client_50"
# 定义客户端数据目录
client_data_dir = "/data2/liujiaqi/openfgl_dataset/source/Amz-Comp/distrib/subgraph_fl_louvain_1_Computers_client_50"
