...
# 定义污染目录
contaminated_client_dir = "/data2/liujiaqi/openfgl_dataset/contaminated/Cora/distrib/subgraph_fl_louvain_1_Cora_client_10"
# 定义客户端数据目录
client_data_dir = "/data2/liujiaqi/openfgl_dataset/source/Cora/distrib/subgraph_fl_louvain_1_Cora_client_10"
