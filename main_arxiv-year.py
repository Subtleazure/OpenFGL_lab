...
args.root = "/data2/liujiaqi/openfgl_dataset/contaminated/arxiv-year"
...
args.lr = 0.01
args.log_dir = '/data2/liujiaqi/OpenFGL-main/log_arxiv-year.txt'
args.accuracy_curve_dir = f'/data2/liujiaqi/OpenFGL-main/accuracy_curve_{args.num_rounds}_lr_0_01_arxiv-year.png'
args.accuracy_curve_html_dir = f'/data2/liujiaqi/OpenFGL-main/accuracy_curve_{args.num_rounds}_lr_0_01_arxiv-year.html'
...
# 定义污染目录
contaminated_client_dir = "/data2/liujiaqi/openfgl_dataset/contaminated/arxiv-year/distrib/subgraph_fl_louvain_1_ogbn-arxiv_client_200"
# 定义客户端数据目录
client_data_dir = "/data2/liujiaqi/openfgl_dataset/source/arxiv-year/distrib/subgraph_fl_louvain_1_ogbn-arxiv_client_200"
