...
args.accuracy_curve_dir = f'/data2/liujiaqi/curves/CiteSeer/accuracy_curve_{args.num_rounds}_lr_0_01_CiteSeer_ben.png'
args.accuracy_curve_html_dir = f'/data2/liujiaqi/curves/CiteSeer/accuracy_curve_{args.num_rounds}_lr_0_01_CiteSeer_ben.html'
...
# 定义污染目录
contaminated_client_dir = "/data2/liujiaqi/openfgl_dataset/contaminated/CiteSeer/distrib/subgraph_fl_louvain_1_CiteSeer_client_10"
# 定义客户端数据目录
client_data_dir = "/data2/liujiaqi/openfgl_dataset/source/CiteSeer/distrib/subgraph_fl_louvain_1_CiteSeer_client_10"
...
average_index_main(args.aggregation_mode, args.log_dir, "/data2/liujiaqi/OpenFGL-main/weight_CiteSeer.txt")